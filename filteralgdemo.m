...
%c2=lagrfdes(ideal,37,0.610,0.610,2,10^(75/10),10^(45/10));
...
aclra=powint2(zpad(a,1024),1,313,313,513)
aclrb=powint2(zpad(b,1024),1,313,313,513)
aclrc=powint2(zpad(c,1024),1,313,313,513)
%aclrc2=powint2(zpad(c2,1024),1,313,313,512)
aclrideal=powint2(zpad(ideal,1024),1,313,313,512)
